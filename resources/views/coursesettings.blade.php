    ...
    <div class="page">
        <div class="left-sidebaruser1">
            <div class="left-sidebar1">
              <form action="{{url('/course_code')}}" method="post">
                    {{csrf_field()}}
      		        <div style="margin-left:20% ; margin-top:30% ;">
                      <input type="button" name="addconfirm" class="button2 button"  value="Add course" style="width:180PX ;"><br>
                      <input type="button" name="updateconfirm" class="button2 button"  value="Update Course" style="width:180PX ;"><br>
                      <input type="button" name="deleteconfirm" class="button2 button"  value="Delete Course" style="width:180PX ;"><br>
                      <input type="button" name="viewconfirm" class="button2 button"  value="View" style="width:180PX ;"><br>
		...
		<div class="right-sidebar1">
		    <div style="margin-left:10% ; margin-top:30% ;">
                ...
                <div class="textbox">
                    ...
                    <input type="text" ID="courseid" name="courseid" placeholder="Enter Course Id" Visible="true"></input>
                </div>

                <div class="textbox">
                    <i class="fa fa-comment-o" aria-hidden="true"></i>
                    <input type="text" ID="coursenamebox" name="coursename" placeholder="Enter Course Name" Visible="true"></input>
                </div>

                <div class="textbox">
                    <i class="fa fa-user" aria-hidden="true"></i>
                    <input type="number" ID="teacherid" name="teacherid" placeholder="Enter Teacher Id" Visible="true"></input>
                </div>

                <div style="margin-left:15% ;">
                  <input type="submit" name="submit" id="updateconfirm" class="button2 button"  value="Add Now" style="width:180PX ;"><br>
                </div>
              </form>
		    </div>
		</div>
